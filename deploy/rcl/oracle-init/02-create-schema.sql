...
BEGIN
  FOR t IN (SELECT table_name FROM user_tables WHERE table_name IN ('BOM','ITEM','MATERIAL','USERS')) LOOP
...
INSERT INTO Users (user_id, password, user_name) VALUES ('id1', 'password1', 'ユーザー1');
INSERT INTO Users (user_id, password, user_name) VALUES ('id2', 'password2', 'ユーザー2');
